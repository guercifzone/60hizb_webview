...
public class Laayoun_Alkoushi_Activity extends AppCompatActivity implements  OnclickListView_Adapter.customButtonListener {
    private ListView listView;
    private WebView mywebview;
    OnclickListView_Adapter adapter;
    ProgressDialog mProgressDialog;
    ArrayList<String> dataItems = new ArrayList<String>();
    final Laayoun_Alkoushi_Activity.DownloadTask downloadTask = new DownloadTask(Laayoun_Alkoushi_Activity.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new OnclickListView_Adapter(Laayoun_Alkoushi_Activity.this, dataItems);
        adapter.setCustomButtonListner(Laayoun_Alkoushi_Activity.this);
        listView.setAdapter(adapter);
        mProgressDialog = new ProgressDialog(Laayoun_Alkoushi_Activity.this);
    ...
    private class DownloadTask extends AsyncTask<String, Integer, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                output = new FileOutputStream(Environment.getExternalStorageDirectory() + "/Download/video.mp3");
