...
public class Kiraa_jamaaia_Activity extends AppCompatActivity implements  OnclickListView_Adapter.customButtonListener {
    private ListView listView;
    private WebView mywebview;
    OnclickListView_Adapter adapter;
    ProgressDialog mProgressDialog;
    ArrayList<String> dataItems = new ArrayList<String>();
    final Kiraa_jamaaia_Activity.DownloadTask downloadTask = new DownloadTask(Kiraa_jamaaia_Activity.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new OnclickListView_Adapter(Kiraa_jamaaia_Activity.this, dataItems);
        adapter.setCustomButtonListner(Kiraa_jamaaia_Activity.this);
        listView.setAdapter(adapter);
        mProgressDialog = new ProgressDialog(Kiraa_jamaaia_Activity.this);
