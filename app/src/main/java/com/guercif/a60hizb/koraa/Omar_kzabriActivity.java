...
public class Omar_kzabriActivity extends AppCompatActivity implements  OnclickListView_Adapter.customButtonListener {
    private ListView listView;
    private WebView mywebview;
    OnclickListView_Adapter adapter;
    ProgressDialog mProgressDialog;
    ArrayList<String> dataItems = new ArrayList<String>();
    final Omar_kzabriActivity.DownloadTask downloadTask = new DownloadTask(Omar_kzabriActivity.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new OnclickListView_Adapter(Omar_kzabriActivity.this, dataItems);
        adapter.setCustomButtonListner(Omar_kzabriActivity.this);
        listView.setAdapter(adapter);
        mProgressDialog = new ProgressDialog(Omar_kzabriActivity.this);
